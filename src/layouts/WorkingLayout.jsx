        ...
        <ProtectedRoute>
            <div className="w-screen relative pb-10">
                ...
                <div className="min-w-screen">
                    <WorkingSidebar />
                    <main className="absolute w-screen xl:min-h-screen xl:w-[984px] scrollbar-none md:px-3 2xl:left-110 max-2xl:flex max-2xl:items-start max-2xl:justify-center -mt-5 xl:top-0 xl:left-42">
                        {children}
                    </main>
                </div>
            </div>

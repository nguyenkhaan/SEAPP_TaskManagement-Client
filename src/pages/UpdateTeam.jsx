...
function UpdateTeam() {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: "text-sm md:text-[18px] h-42 md:h-47 overflow-y-scroll w-full border border-[#757070] text-(--color-text) bg-(--color-block-item-2) font-md rounded-[10px] py-3 px-3 md:px-5",
            },
        },
    });

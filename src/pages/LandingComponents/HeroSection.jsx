        ...
        <div className=' bg-[--color-background-1] xl:pt-28 lg:pt-25 md:pt-20 pt-15 pb-8 landing__section relative before:bg-[--color-background-1] before:z-[-1] before:absolute before:top-0 before:h-full before:left-1/2 before:translate-x-[-50vw] before:w-screen'>
            <div className='flex gap-3 lg:flex-row flex-col items-center lg:justify-between pt-8'>
                <div className='flex flex-col xl:gap-4 lg:gap-3 gap-2 flex-1 xl:ml-0 lg:ml-10' data-aos='fade-right'>
                    ...
                    <h2 className='xl:text-7xl lg:text-5xl md:text-6xl sm:text-[32px] text-[28px] lg:text-start text-center font-medium text-(--color-text)'>
                        Manage your Task
                        <span className=' text-(--color-primary) lg:block mt-2'> Efforlessly</span>
                    </h2>
                    {/* paragraph */}
                    <p className='block xl:w-170 lg:w-100 w-screen lg:px-0 md:px-3 px-5 lg:text-start text-center  text-(--color-text) xl:pt-6 lg:pt-5 md:pt-4 pt-1 lg:text-2xl md:text-[22px] text-[20px] '>

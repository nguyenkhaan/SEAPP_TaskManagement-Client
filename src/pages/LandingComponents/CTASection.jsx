    ...
    return (
        <section className='landing__section py-18  bg-(--color-primary) relative 
            ...
            <div className='w-full h-full flex items-center flex-col justify-center'>
                <h2 data-aos='zoom-in' className='text-white lg:w-[947px] md:w-[900px] w-[412px] font-medium lg:text-[84px] md:text-[70px] text-[38px] lg:leading-28 md:leading-20 leading-13 text-center'>Ready to Boost your Productivity?</h2>
                ...
                <div className="flex my-8 justify-between xl:w-[1142px] lg:w-[1050px] md:w-[800px] md:flex-row flex-col gap-10 items-center">
                    <Link to='/login'>
                        <button data-aos='fade-right' className='lg:w-[490px] md:w-[370px] w-[350px] cursor-pointer bg-white lg:h-[100px] md:h-[90px] h-[80px] py-2 px-[14x] text-(--color-primary) rounded-[158px] xl:text-[40px] md:text-[32px] text-[28px] font-medium shadow-[0_0_20px_rgba(0,0,0,0.15)] hover:shadow-[0_0_30px_rgba(0,0,0,0.25)] transition-all duration-300'>
                            Login
                        </button>

                    </Link>
                    <Link to={'/register'}>
                        <button data-aos='fade-left' className='lg:w-[490px] md:w-[370px] w-[350px] cursor-pointer lg:h-[100px] md:h-[90px] h-[80px] py-2 px-[14px] bg-(--color-primary) text-white rounded-[158px] xl:text-[40px] md:text-[32px] text-[28px] font-medium shadow-[0_0_20px_rgba(0,0,0,0.15)] hover:shadow-[0_0_30px_rgba(0,0,0,0.25)] transition-all duration-300'>
                            Sign up right now
                        </button>
                    </Link>
                </div>

...
function Appearance() {
    ...
    return (
        <SectionSetting
            header="Appearance"
            description="Customize your website appearance by choosing between light, dark theme. Personalize your viewing experience to make the interface more comfortable, visually appealing, and perfectly aligned with your style.">

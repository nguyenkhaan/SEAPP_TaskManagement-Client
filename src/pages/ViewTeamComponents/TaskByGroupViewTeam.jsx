...
function TaskByGroupViewTeam({
    ...
    return (
        <article className={`rounded-2xl flex flex-col items-start px-2 md:px-7 task__group justify-between shadow-[0_0_15px_rgba(0,0,0,0.3)] overflow-hidden  text-black`} style={{ width, height }}>
            ...
            <ul className='w-full flex-1 md:px-6 md:p-5 overflow-y-scroll overflow-x-hidden wrapper h-full flex flex-col items-center pb-6'>

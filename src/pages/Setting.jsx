...
function Setting() {
    return (
        <WorkingLayout>
            <h2 className='font-md max-md:px-3 text-3xl md:text-4xl'>Settings</h2>
            <span className='font-md max-md:px-3 block my-2 text-lg md:text-xl'>Manage your profile, preferences, and app settings</span>

    ...
    return (
        <article className='w-[402px] relative h-[153px] px-8 py-2 flex overflow-hidden rounded-2xl border bg-transparent border-[#A1A3AB] font-[Inter]'>
            <div className='flex-3 flex-col flex items-start justify-between '>
                ...
                <div>
                    <p className='text-[12px] text-(--color-text-desc)'>
                        Status:
                        <span className='text-(--color-in-progress)'> In Progress</span>
                    </p>
            ...
            <div className='flex-2 flex items-center justify-end'>
                <Gauge width={112} height={112} value={statusValue} startAngle={360} endAngle={0} fontSize={20} text={`${statusValue}%`} fontWeight={500} color='black'/>
            </div>
            <i class="fa-regular fa-circle top-2 left-3 font-black absolute text-(--color-in-progress) text-[12px]"></i>

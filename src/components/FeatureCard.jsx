...
function FeatureCard({
    ...
    return (
        <article className='rounded-[20px] bg-(--color-secondary) flex w-[404px] h-[358px] items-start justify-center gap-4 flex-col px-9 py-5'>
            ...
            <h3 className='text-(--color-text) text-2xl font-[Montserrat]'>Task management</h3>

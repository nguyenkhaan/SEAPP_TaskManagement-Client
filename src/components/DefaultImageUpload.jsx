...
function DefaultImageUpload({
    url = 'https://images.stockcake.com/public/3/5/0/35000166-188c-4bbd-ac7d-0941be325558_large/sunny-cloud-filled-sky-stockcake.jpg'
}) {
    return (
        <div
            ...
            title="Đừng có bấm. Không có thay được đâu =))"
            style={{

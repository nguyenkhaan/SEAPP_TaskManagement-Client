...
function Section5() {
    return (
        <div className='landing__section py-18  bg-[#ff6766]'>
            <div className='w-full h-full flex items-center flex-col justify-center'>
                <h2 className='text-white w-[947px] font-medium text-[90px] leading-28 text-center'>Ready to Boost your Productivity?</h2>
